...
#define CHX_UNSAVED_COLOUR COLOUR_MAGENTA
#define CHX_ASCII_CUR_FORMAT COLOUR_YELLOW
#define CHX_ASCII_SELECT_FORMAT COLOUR_RED
#define CHX_SELECT_FORMAT COLOUR_RED
